def compute_free_cells(cell_list, c_obs_list):
    ...
    #return f_cell_list
    print 'whole list',f_cell_list

cell_list = [-300,-208,300,200]
c_obs_list = [[-128,-208,28,-112],[-168, -208, -72, -52],[-128, 112, 28, 208],[-168, 52, -72, 208],[-28, -78, 68, 78],[-288, -48, -192, 48],[12, 32, 168, 128]] 

compute_free_cells(cell_list,c_obs_list) 
