...
/* =======================================================================
   ...
   A simple simulator for Hamster. Simulated Hamster is controlled by (w,a,s,d)
   keys. This program also serves as a starter program
   for students to implement collision checking of Hamster simulator. The
   collision checking method called by ThreadedVirtualWorld::update_virtual_world()
   in this module, is in virtual_world::in_collision() in module tk_hamster_simulator.py.
...
class GUIpart(object):    
    ...
    def initUI(self):
        ...
        #creating visual appearance of Hamster
...
class ThreadedVirtualWorld(object):
    ...
    # Update data components of the simulator. Updating graphics
    # is all done in the main/GUI thread.
    def update_virtual_world(self, virtual_world):
        ...
        d_factor = 1.3 #travel distance conversion
        ...
        while not self.gQuit:
            ...
            # of its pose.
            ##########################
            if not virtual_world.in_collision(new_vrobot_a, new_vrobot_x, new_vrobot_y):
